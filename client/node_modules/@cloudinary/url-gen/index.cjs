...
var actions = require('./actions-17c32546.cjs');
var qualifiers = require('./qualifiers-2e9b42db.cjs');
var Transformation = require('./Transformation-afb1a22d.cjs');
var ImageTransformation = require('./ImageTransformation-38968233.cjs');
var VideoTransformation = require('./VideoTransformation-46d486f2.cjs');
...
require('./resize-0b373f66.cjs');
require('./ResizePadAction-26d9246d.cjs');
require('./ResizeAdvancedAction-afd453c6.cjs');
require('./ResizeSimpleAction-1d549575.cjs');
...
require('./ResizeScaleAction-3dca1cad.cjs');
require('./ThumbnailAction-acca48c4.cjs');
require('./ResizeCropAction-17b70d13.cjs');
require('./ResizeFillAction-a5f74437.cjs');
require('./ResizeLimitFitAction-20b1df5c.cjs');
require('./ResizeLimitFillAction-a6523267.cjs');
require('./ResizeLimitPadAction-db9bf504.cjs');
require('./ResizeMinimumPadAction-a7ff8d68.cjs');
require('./border-a99ff1a7.cjs');
require('./RoundCornersAction-dd775a4c.cjs');
require('./roundCorners-3c83ddd2.cjs');
require('./effect-5d363d02.cjs');
require('./Blur-a404afba.cjs');
require('./region-f921a784.cjs');
require('./NamedRegion-d66fff1d.cjs');
require('./RectangleRegion-fff99f96.cjs');
require('./Accelerate-136bb4e5.cjs');
require('./Loop-6f02252c.cjs');
require('./LeveledEffectAction-e694bcc3.cjs');
require('./SimpleEffectAction-f2378a9b.cjs');
require('./Cartoonify-09deff4d.cjs');
require('./Outline-5699255a.cjs');
require('./MakeTransparent-3671c5f5.cjs');
require('./Vectorize-61c48b0e.cjs');
require('./SimulateColorBlind-496c47d6.cjs');
require('./EffectActionWithLevel-8974c9f1.cjs');
require('./AssistColorBlind-0e74e40a.cjs');
require('./GradientFade-9d24c805.cjs');
require('./FadeOut-7a32a2a3.cjs');
require('./Colorize-25a0b969.cjs');
require('./Shadow-113eaac2.cjs');
require('./StyleTransfer-1bcf1cb7.cjs');
require('./Dither-c3f6c615.cjs');
require('./Deshake-38ce6d7c.cjs');
require('./Pixelate-20b32399.cjs');
require('./EffectActionWithStrength-863b70d1.cjs');
require('./Blackwhite-f4c5ef7c.cjs');
require('./FadeIn-6762b467.cjs');
require('./RemoveBackgroundAction-7bbffcc9.cjs');
require('./Theme-3166e9c9.cjs');
require('./BackgroundRemoval-0f3264b8.cjs');
require('./DropShadow-1aecd208.cjs');
require('./GenerativeRemove-2288328c.cjs');
require('./GenerativeReplace-07bf60dc.cjs');
require('./GenerativeRecolor-39491acc.cjs');
require('./rotate-b37e0219.cjs');
require('./RotateAction-26eb1004.cjs');
require('./adjust-d1891189.cjs');
require('./FillLightAction-0fc49d64.cjs');
require('./RecolorAction-b6b06f88.cjs');
require('./OpacityAdjustAction-17f74b54.cjs');
require('./By3dLutAction-0e9ae162.cjs');
require('./ImproveAction-cdd16b5f.cjs');
require('./ReplaceColorAction-953def82.cjs');
require('./EffectActionWithBlend-2a068677.cjs');
require('./ViesusCorrectAdjustAction-99284761.cjs');
require('./overlay-be62401f.cjs');
require('./LayerAction-b6768494.cjs');
...
require('./underlay-db19ce98.cjs');
require('./namedTransformation-07a06ae5.cjs');
require('./NamedTransformationAction-b099e31d.cjs');
require('./delivery-07ada5f5.cjs');
require('./DeliveryQualityAction-7474524b.cjs');
require('./DeliveryColorSpaceFromICCAction-23674665.cjs');
require('./DeliveryColorSpaceAction-8c035a51.cjs');
require('./colorSpace-e71e2b55.cjs');
require('./DeliveryDPRAction-d6cf220a.cjs');
require('./customFunction-f41b8666.cjs');
require('./CustomFunctionAction-722877aa.cjs');
require('./RemoteAction-53e76682.cjs');
require('./videoEdit-7412a050.cjs');
require('./TrimAction-aefecb4a.cjs');
require('./ConcatenateAction-9c49408d.cjs');
require('./VolumeAction-17cb965f.cjs');
require('./PreviewAction-d846fde2.cjs');
require('./transcode-516b3104.cjs');
...
require('./StreamingProfile-f02db0d2.cjs');
...
require('./psdTools-5fbdc251.cjs');
require('./ClipAction-018974f3.cjs');
require('./GetLayerAction-e121209f.cjs');
require('./SmartObjectAction-a74cce13.cjs');
require('./animated-455c7501.cjs');
...
require('./expression-a468c1ae.cjs');
